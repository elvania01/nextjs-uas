...
export default function SpecialEventCategory() {
  const products = [
    { id: 1, name: "Graduation Glory", image: "/products/special-graduation.jpg", price: "Rp 175.000" },
    { id: 2, name: "Holiday Spark Bundle", image: "/products/special-holiday.jpg", price: "Rp 210.000" },
  ];
