...
export default function AnniversaryCategory() {
  const products = [
    { id: 1, name: "Romantic Tulips", image: "/products/anniversary-tulip.jpg", price: "Rp 180.000" },
    { id: 2, name: "Love in Bloom", image: "/products/anniversary-love.jpg", price: "Rp 210.000" },
  ];
  ...
  return (
    <div className="p-8">
      <h1 className="font-pacifico text-3xl font-bold text-pink-600 mb-6">Anniversary Collection</h1>
